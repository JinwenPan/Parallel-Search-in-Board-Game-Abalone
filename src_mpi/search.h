...
public:
   ...
   virtual void start_silent(int msecsForSearch); // no annoying prints even if verbose
...
public:
   ...
   int _SS_bestEval; // global variable to store the best value
...
protected:
   ...
   // virtual void searchkthMove(int) = 0;
