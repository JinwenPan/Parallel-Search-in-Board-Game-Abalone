...
void SearchCallbacks::start_silent(int msecsForSearch)
{
    _leavesVisited = 0;
    _nodesVisited = 0;
    gettimeofday(&t1, 0);
...
bool SearchCallbacks::afterEval()
{
    ...
    if (evalCounter < ms * kevalsPerSec)
        return false;
